          ...
          >
            <div className="relative group">
              <div className="w-full h-[500px] bg-gradient-to-br from-primary/20 via-secondary/20 to-accent/20 rounded-3xl flex items-center justify-center overflow-hidden shadow-2xl">
                <div className="text-8xl font-bold text-primary/80 mb-4">BC</div>
              </div>
          ...
          >
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-primary font-semibold mb-6">Senior Full-Stack Developer & Technical Consultant</p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  {["React/Next.js", "TypeScript", "Node.js", "Python", "MongoDB", "AWS", "Docker", "Git"].map((tech, index) => (
                    <span 
                      key={tech} 
                      className="px-4 py-2 bg-gradient-to-r from-primary/10 to-secondary/10 text-foreground rounded-full text-sm font-medium border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:scale-105"
